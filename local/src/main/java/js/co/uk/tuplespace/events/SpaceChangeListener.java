...
/**
 * 
 * Listener for changes to a space
 */
public interface SpaceChangeListener extends EventListener {

    /**
     * Handler for a SpaceChange
     * @param evt
     */
    void spaceChanged(final SpaceChange evt);
