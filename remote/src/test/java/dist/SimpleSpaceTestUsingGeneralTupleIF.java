 ...
 */
public class SimpleSpaceTestUsingGeneralTupleIF {
    /**
     * The space.
     */
    private Space space;
    ...
    public void setUp() throws Exception {
        ...
        space = localSpaceCreator.createSpace( "SimpleSpaceTestUsingGeneralTupleIF");
    ...
    @Test
    public void manyWritesToSharedVar(){

        SharedVar counter = new SharedVar("count", 0);
